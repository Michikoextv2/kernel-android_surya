...
int sysctl_tcp_min_tso_segs __read_mostly = 1;	/* OPTIMIZED: reduced from 2 for lower latency on mobile */

int sysctl_tcp_autocorking __read_mostly = 0;	/* OPTIMIZED: disabled for latency (was 1) */
